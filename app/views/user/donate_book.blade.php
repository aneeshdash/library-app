            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel effect1  panel-info">
                    <div class="panel-heading" >
                        <div class="text-center"><strong style="font-size: 20px;">DONATE BOOK FORM</strong></div>
                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal" id="donate_book"  role="form">
    ...
    <div class="row mt">
        <div class="col-md-8 col-md-offset-2">
            <section class="task-panel tasks-widget">
                <div class="panel-heading">
                    <div class="text-center"><strong style="font-size:20px;">Donate-Book Log</strong></div>
                    <br>
                </div>
                <div class="panel-body">
                    <div class="task-content">
                        ...
                        <ul class="task-list">
                            ...
                            @foreach(DB::table('donate_book')->where('donor_id', Auth::user()->get()->id )->get() as $log)
                                <li id="li-{{$log->id}}">
                                    <div class="task-title">
                                        <span>{{$log->book_title}}</span>
                                        <div class="pull-right">
                                            <a id="btn1-{{$log->id}}" class="btn btn-info btn-xs" href="{{route('printLog_donate',Crypt::encrypt($log->id))}}" target="_blank"><i class="fa fa-print"></i></a>
...
@section('scripts')
    ...
    <script>
        ...
        function Ajax_Post(){
            $.ajax({
                url: "{{ route('user_add_donate_book') }}",
                method: 'POST',
                data: $('#donate_book').serialize()
            })
                    .success(function () {
...
//                            var cnf1 = confirm("The ISBN you entered doesn't meet ISO standards\n\n Do You still want to submit?");
    ...
    <!-- javascript for showing publications input field -->
    <script>
