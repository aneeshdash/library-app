...
@section('content')
    <section class="content-header">
        ...
        <button class="btn btn-primary btn-md" style="margin-top: 1%" data-toggle="modal" data-target="#newModal">+ Add Publication</button>
    </section>
                            ...
                            @foreach(Publication::all() as $pub)
                                <tr>
                                    ...
                                    <td><div class="btn-group">
                                            <button type="button" class="btn btn-info" onclick="edit({{ $i }},{{ $pub->id}})" id="BTECH">Edit</button>
                                            <button type="button" class="btn btn-danger" onclick="del({{ $pub->id }},{{ $i }})">Delete</button>
                                        </div></td>
                                </tr>
                                <?php $i++; ?>
                            @endforeach
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Update publication Name</h4>
                </div>
                <div class="modal-body">
                    
                        <div class="form-group">
                            <label for="firstname" class="col-sm-3 control-label">publication:</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter publication" required>
                            </div>
                        </div>
                    <input type="hidden" id="pub_id" name="id" value="">
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="firstname" class="col-sm-3 control-label">publication:</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="name" id="new-name" placeholder="Enter publication" required>
                            </div>
                        </div>
    ...
    <div class="modal fade modal-danger" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="font-size: x-large">Do you really want to delete this publication ?</p>
                </div>
                <div class="modal-footer">
